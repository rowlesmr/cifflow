...
fn make_batch(
    ...
    let mut fields = vec![
        Field::new("_cifflow_block_idx",  DataType::Int32, false),
...
mod tests {
    ...
    #[test]
    fn fixture_cifflow_core_cell_only() {
        let p = fixture!("../../tests/cif_files/cifflow/core_cell_only.cif");
        assert_eq!(p.errors.len(), 0);
        assert_eq!(p.blocks.len(), 1);
    }
    #[test]
    fn fixture_cifflow_core_cell_su() { let _ = fixture!("../../tests/cif_files/cifflow/core_cell_su.cif"); }
    #[test]
    fn fixture_cifflow_core_atom_site_no_atom_type() { let _ = fixture!("../../tests/cif_files/cifflow/core_atom_site_no_atom_type.cif"); }
    #[test]
    fn fixture_cifflow_core_alias_tag() { let _ = fixture!("../../tests/cif_files/cifflow/core_alias_tag.cif"); }
    #[test]
    fn fixture_cifflow_core_placeholder_in_loop() { let _ = fixture!("../../tests/cif_files/cifflow/core_placeholder_in_loop.cif"); }
    #[test]
    fn fixture_cifflow_core_quoted_sentinel() { let _ = fixture!("../../tests/cif_files/cifflow/core_quoted_sentinel.cif"); }
    #[test]
    fn fixture_cifflow_core_unknown_tag() { let _ = fixture!("../../tests/cif_files/cifflow/core_unknown_tag.cif"); }
    #[test]
    fn fixture_cifflow_core_multiple_blocks() { let _ = fixture!("../../tests/cif_files/cifflow/core_multiple_blocks.cif"); }
    #[test]
    fn fixture_cifflow_core_multiline_formula() { let _ = fixture!("../../tests/cif_files/cifflow/core_multiline_formula.cif"); }
    #[test]
    fn fixture_cifflow_core_repeated_loop_key() { let _ = fixture!("../../tests/cif_files/cifflow/core_repeated_loop_key.cif"); }
    #[test]
    fn fixture_cifflow_core_keyless_sets() { let _ = fixture!("../../tests/cif_files/cifflow/core_keyless_sets.cif"); }
    #[test]
    fn fixture_cifflow_fallback_scalars() { let _ = fixture!("../../tests/cif_files/cifflow/fallback_scalars.cif"); }
    #[test]
    fn fixture_cifflow_fallback_loop() { let _ = fixture!("../../tests/cif_files/cifflow/fallback_loop.cif"); }
    #[test]
    fn fixture_cifflow_fallback_value_types() { let _ = fixture!("../../tests/cif_files/cifflow/fallback_value_types.cif"); }
    #[test]
    fn fixture_cifflow_fallback_containers() { let _ = fixture!("../../tests/cif_files/cifflow/fallback_containers.cif"); }
    #[test]
    fn fixture_cifflow_fallback_multiblock() { let _ = fixture!("../../tests/cif_files/cifflow/fallback_multiblock.cif"); }
    #[test]
    fn fixture_cifflow_pow_wavelength_propagation() { let _ = fixture!("../../tests/cif_files/cifflow/pow_wavelength_propagation.cif"); }
    #[test]
    fn fixture_cifflow_pow_enumeration_default() { let _ = fixture!("../../tests/cif_files/cifflow/pow_enumeration_default.cif"); }
    #[test]
    fn fixture_cifflow_pow_small_pd_data_meas() { let _ = fixture!("../../tests/cif_files/cifflow/pow_small_pd_data_meas.cif"); }
    #[test]
    fn fixture_cifflow_pow_small_pd_meas_proc() { let _ = fixture!("../../tests/cif_files/cifflow/pow_small_pd_meas_proc.cif"); }

    #[test]
    fn fixture_cifflow_pow_multiple_blocks_canonical_case() {
        let p = fixture!("../../tests/cif_files/cifflow/pow_multiple_blocks_canonical_case.cif");
